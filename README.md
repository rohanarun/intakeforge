...
![IntakeForge sample workspace](./docs/product-workspace.png)
...
intakeforge page '{"limit":50,"state":"active","search":"Title prefix"}'
intakeforge detail '00000000-0000-4000-8000-000000000001'
...
```bash
docker build -t intakeforge:0.3.0 .
